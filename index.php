  ...
  <body>  
      ...
      <div class="search-container">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1>Helper, for your needs.</h1><br><h2>Service <strong>above</strong> self!</h2>
              <div class="content">
                <form method="" action="">
                  <div class="row">
    ...
    <section class="find-job section">
      <div class="container">
        <h2 class="section-title">Latest Services Required</h2>
        <div class="row">
          <div class="col-md-12">
            <div class="job-list">
              <div class="thumb">
              ...
              <div class="job-list-content">
                <h4><a href="job-details.html">Need a Fulltime Cook</a><span class="full-time">Full-Time</span></h4>
                ...
                <div class="job-tag">
                  <div class="pull-left">
                    <div class="meta-tag">
                      <span><a href="browse-categories.html"><i class="ti-pie-chart"></i>Cooking</a></span>
                      <span><i class="ti-location-pin"></i>Selangor</span>
                      <span><i class="ti-time"></i>RM20/Hour</span>
                    </div>
                  </div>
            ...
            <div class="job-list">
              ...
              <div class="job-list-content">
                <h4><a href="job-details.html">Require Nanny/Nurse</a><span class="full-time">Full-Time</span></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum quaerat aut veniam molestiae atque dolorum omnis temporibus consequuntur saepe. Nemo atque consectetur saepe corporis odit in dicta reprehenderit, officiis, praesentium?</p>
                <div class="job-tag">
                  <div class="pull-left">
                    <div class="meta-tag">
                      <span><a href="browse-categories.html"><i class="ti-desktop"></i>Nurse</a></span>
                      <span><i class="ti-location-pin"></i>Kuala Lumpur, Malaysia</span>
                      <span><i class="ti-time"></i>RM40/Hour</span>
                    </div>
                  </div>
                  <div class="pull-right">
                    <div class="icon">
            ...
            <div class="job-list">
              ...
              <div class="job-list-content">
                <h4><a href="job-details.html">Part time Maid</a><span class="part-time">Part-Time</span></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum quaerat aut veniam molestiae atque dolorum omnis temporibus consequuntur saepe. Nemo atque consectetur saepe corporis odit in dicta reprehenderit, officiis, praesentium?</p>
                <div class="job-tag">
                  <div class="pull-left">
                    <div class="meta-tag">
                      <span><a href="browse-categories.html"><i class="ti-home"></i>Cleaning</a></span>
                      <span><i class="ti-location-pin"></i>Kajang, Malaysia</span>
                      <span><i class="ti-time"></i>RM50/Hour</span>
                    </div>
                  </div>
                  <div class="pull-right">
                    <div class="icon">
          ...
          <div class="col-md-12">
            <div class="showing pull-left">
              <a href="#">Showing <span>1-3</span> Of 5 Jobs</a>
            </div>                    
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/img/blog/home-items/01.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">
                ...
                <a href="single-post.html">
                  <h3>
                    Malaysia needs laws to protect Elderly rights
                  </h3>
                </a>
                <p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/img/blog/home-items/02.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
                  <span class="date"><i class="ti-calendar"></i> Jun 20, 2018</span>
                  <span class="comments"><a href="#"><i class="ti-comment-alt"></i> 3 Comments</a></span>
                </div>
                <a href="single-post.html">
                  <h3>
                    Elderly Homeless number increases!
                  </h3>
                </a>
                <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore praesentium asperiores ad vitae.
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="assets/img/blog/home-items/03.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">
                <div class="meta-tags">
                  <span class="date"><i class="ti-calendar"></i> Aug 10, 2018</span>
                  <span class="comments"><a href="#"><i class="ti-comment-alt"></i> 2 Comments</a></span>
                </div>
                <a href="single-post.html">
                  <h3>
                    Making Golden Years the best years.
                  </h3>
                </a>
                <p>
                 Malaysia has an ageing problem. Compared to European countries which took 100 years to double their populations aged 65 and above.
                </p>
                <a href="single-post.html" class="btn btn-common btn-rm">Read More</a>
              </div>
            </div>
